#ifndef ORCAGFACTORY_H
#define ORCAGFACTORY_H
#include "Log.hh"
...
/*!
  \brief Concrete factory for Orca Grid type jobs ("OrcaG").

  This concrete factory will create the appropriate combination of classes (and choose the
  correct wrapper script) for Orca Grid type jobs. To decide whether Db or New type classes
...
class OrcaGFactory : public TaskFactory {
public:
  ...
  JDL* makeJDL(const Job* aJob, CladLookup* aUserSpec, const string aFileName) const;
