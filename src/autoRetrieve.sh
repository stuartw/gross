...
INTERVAL=3600 #time between retrievals in seconds
JOBSLEFT=0
LENGTH=12 #number of time to run multiply by $INTERVAL to get time script will run for
...
while [ 1 ]
do
  out=`gross o -taskId $TASK -oDir $OUTPUT -cont`
  JOBSLEFT=$?
